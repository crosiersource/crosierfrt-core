      ...
      <div class="w-11/12 sm:w-[30rem]">
        <div class="flex flex-col">
          <div
            ...
            <i class="pi pi-lock text-primary !text-4xl" />
          </div>
          <div class="mt-6">
        ...
        <div class="flex flex-col gap-4 mt-12">
          <div class="flex justify-between items-center">
            ...
            <Button class="text-primary-500" text icon="pi pi-sign-out" label="Log out" />
          </div>
          <InputGroup>
            <InputGroupAddon>
              <i class="pi pi-key" />
            </InputGroupAddon>
            <Password id="password" placeholder="Password" input-class="w-full" />
          </InputGroup>
          <InputGroup>
            <Button class="w-full" label="UNLOCK" />
          </InputGroup>
          <InputGroup>
            <Button class="w-full text-primary-500" text label="SWITCH ACCOUNT" />
          </InputGroup>
        </div>
      </div>
    </div>
