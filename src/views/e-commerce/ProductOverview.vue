...
<template>
  <div class="card">
      ...
      <div class="col-span-12 lg:col-span-4 py-4 lg:pl-12">
        ...
        <div class="flex items-center justify-between mb-8">
          ...
          <div class="flex items-center">
            <span class="mr-4">
              ...
              <i class="pi pi-star-fill text-yellow-500 mr-1" />
              <i class="pi pi-star-fill text-yellow-500 mr-1" />
              <i class="pi pi-star text-surface-600 dark:text-surface-200 mr-1" />
            </span>
            <span class="text-sm">
        ...
        <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between">
          <InputNumber
            ...
            :min="0"
            input-class="w-12 text-center py-2 px-1 border-transparent outline-0 shadow-none"
    ...
    <Tabs value="0">
      ...
      <TabPanels>
        <TabPanel value="0">
          <div class="text-surface-900 dark:text-surface-0 font-bold text-3xl mb-6 mt-2">
            Product Details
          </div>
          <p class="leading-normal text-surface-600 dark:text-surface-200 p-0 mx-0 mt-0 mb-6">
            Volutpat maecenas volutpat blandit aliquam etiam erat velit scelerisque in. Duis
            ultricies lacus sed turpis tincidunt id. Sed tempus urna et pharetra. Metus vulputate eu
            scelerisque felis imperdiet proin fermentum. Venenatis urna cursus eget nunc scelerisque
            viverra mauris in. Viverra justo nec ultrices dui sapien eget mi proin. Laoreet
            ...
            <div class="col-span-12 lg:col-span-4">
              ...
              >
                ...
                <li class="flex items-center whitespace-nowrap w-40 mb-4">
                  <i class="pi pi-times-circle mr-2 text-surface-900 dark:text-surface-0" />
                  <span>No chemical wash</span>
                </li>
                <li class="flex items-center whitespace-nowrap w-40 mb-4 mr-2">
                  <i class="pi pi-sliders-h mr-2 text-surface-900 dark:text-surface-0" />
                  <span>Iron medium heat</span>
                </li>
                <li class="flex items-center whitespace-nowrap w-40 mb-4">
                  <i class="pi pi-minus-circle mr-2 text-surface-900 dark:text-surface-0" />
                  <span>Dry flat</span>
                </li>
              </ul>
            </div>
          ...
          <ul class="list-none p-0 m-0">
            <li class="pb-8 border-b border-surface-200 dark:border-surface-700">
              <span>
                ...
                <i class="pi pi-star-fill text-yellow-500 mr-1" />
                <i class="pi pi-star-fill text-yellow-500 mr-1" />
                <i class="pi pi-star-fill text-gray-500" />
              </span>
        ...
        <TabPanel value="2">
          ...
          <p class="leading-normal text-surface-600 dark:text-surface-200 p-0 mx-0 mt-0 mb-6">
            ...
            vulputate ut pharetra. Tempus egestas sed sed risus. Feugiat sed lectus vestibulum
            mattis. Tristique nulla aliquet enim tortor at auctor urna nunc. Habitant morbi
            tristique senectus et. Facilisi nullam vehicula ipsum.
          </p>
