...
<template>
    <div class="bg-surface-50 dark:bg-surface-950">
        <div style="height: 68px; backdrop-filter: blur(17px)" class="flex justify-between items-center z-30 px-8 bg-black/40 top-0 w-full fixed">
            ...
            <a class="cursor-pointer block lg:hidden text-white" v-styleclass="{ selector: '@next', hideOnOutsideClick: true, enterFromClass: 'hidden', leaveToClass: 'hidden' }">
                <i class="pi pi-bars !text-4xl"></i>
            </a>

            <div id="menu" class="items-center grow hidden lg:flex absolute lg:static w-full lg:px-0 z-30 shadow lg:shadow-none animate-fadein" style="top: 68px; right: 0%">
                <ul class="list-none p-4 lg:p-0 m-0 ml-auto flex lg:items-center select-none flex-col lg:flex-row cursor-pointer">
                    <li>
                        <a class="flex m-0 md:ml-8 px-0 py-4 text-surface-900 dark:text-surface-0 leading-normal" v-styleclass="{ selector: '#menu', enterFromClass: 'hidden', leaveToClass: 'hidden' }">
                            <span>HOME</span>
                        </a>
                    </li>
                    <li>
                        <a class="flex m-0 md:ml-8 px-0 py-4 text-surface-900 dark:text-surface-0 leading-normal" @click="scrollToElement(features)" v-styleclass="{ selector: '#menu', enterFromClass: 'hidden', leaveToClass: 'hidden' }">
                            <span>FEATURES</span>
                        </a>
                    </li>
                    <li>
                        <a class="flex m-0 md:ml-8 px-0 py-4 text-surface-900 dark:text-surface-0 leading-normal" @click="scrollToElement(collaboration)" v-styleclass="{ selector: '#menu', enterFromClass: 'hidden', leaveToClass: 'hidden' }">
                            <span>COLLABORATION</span>
                        </a>
                    </li>
                    <li>
                        <a class="flex m-0 md:ml-8 px-0 py-4 text-surface-900 dark:text-surface-0 leading-normal" @click="scrollToElement(events)" v-styleclass="{ selector: '#menu', enterFromClass: 'hidden', leaveToClass: 'hidden' }">
                            <span>EVENTS</span>
                        </a>
                    </li>
                    <li>
                        <a class="flex m-0 md:ml-8 px-0 py-4 text-surface-900 dark:text-surface-0 leading-normal" @click="scrollToElement(video)" v-styleclass="{ selector: '#menu', enterFromClass: 'hidden', leaveToClass: 'hidden' }">
                            <span>VIDEO</span>
                        </a>
                    </li>
                    <li>
                        <Button label="LET'S TRY" class="!bg-surface-0 !text-surface-900 !border-surface-900 m-0 mt-4 md:mt-0 md:ml-8"></Button>
                    </li>
                </ul>
            </div>
        </div>
                ...
                <div ref="parallaxBody" class="lg:top-full block absolute left-0 right-0 h-full z-20">
                    ...
                    <div ref="features" class="pt-8" style="background-color: #000">
                        <div ref="parallaxBody" class="flex flex-col items-center gap-4">
                            <div class="bg-surface-500 dark:bg-surface-300 text-white text-sm p-2 rounded-lg">FEATURES</div>
                        ...
                        <div class="flex flex-col items-center">
                            ...
                            <div ref="collaboration" style="max-width: 1200px" class="flex flex-col lg:flex-row gap-20 mt-12 py-12 px-6 w-full">
                            ...
                            <div ref="events" style="max-width: 1200px" class="flex flex-col lg:flex-row gap-20 mt-12 py-12 px-6 w-full">
                            ...
                            <div ref="video" style="max-width: 1200px" class="flex gap-6 mt-12 py-12 flex-col items-center w-full">
