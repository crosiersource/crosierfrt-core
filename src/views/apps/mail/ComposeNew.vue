  ...
  <div class="bg-surface-0 dark:bg-surface-950 grid gap-4 mt-6 grid-nogutter p-6 md:border-surface-200 dark:md:border-surface-700 md:border rounded">
    <div class="col-span-12">
      ...
      <IconField style="height: 3.5rem" class="mt-4">
        ...
        <InputText id="to" v-model="newMail.to" type="text" class="pl-16 text-surface-900 dark:text-surface-0 font-semibold" fluid style="height: 3.5rem" />
      </IconField>
    </div>
    <div class="col-span-12">
      ...
      <IconField style="height: 3.5rem" class="mt-4">
        ...
        <InputText id="subject" v-model="newMail.title" type="text" placeholder="Subject" class="!pl-16 text-surface-900 dark:text-surface-0 font-semibold" fluid style="height: 3.5rem" />
      </IconField>
    </div>
    <div class="col-span-12">
      <Editor v-model="newMail.message" editor-style=" height: 250px " />
    </div>
