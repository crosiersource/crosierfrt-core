  ...
  <div class="grid grid-cols-12 gap-8">
      ...
      <div class="card flex flex-col">
        ...
        <div class="flex justify-between mt-4 flex-wrap">
          ...
          <div class="flex items-end">
            <Chart type="line" :data="overviewChartData1" :options="overviewChartOptions1" :height="60" :width="160" />
          </div>
        </div>
      </div>
    </div>
    <div class="col-span-12 md:col-span-6 lg:col-span-3">
      <div class="card flex flex-col">
        ...
        <div class="flex justify-between mt-4 flex-wrap">
          ...
          <div class="flex items-end">
            <Chart type="line" :data="overviewChartData2" :options="overviewChartOptions2" :height="60" :width="160" />
          </div>
        </div>
      </div>
    </div>
    <div class="col-span-12 md:col-span-6 lg:col-span-3">
      <div class="card flex flex-col">
        ...
        <div class="flex justify-between mt-4 flex-wrap">
          ...
          <div class="flex items-end">
            <Chart type="line" :data="overviewChartData3" :options="overviewChartOptions3" :height="60" :width="160" />
          </div>
        </div>
      </div>
    </div>
    <div class="col-span-12 md:col-span-6 lg:col-span-3">
      <div class="card flex flex-col">
        ...
        <div class="flex justify-between mt-4 flex-wrap">
          ...
          <div class="flex items-end">
            <Chart type="line" :data="overviewChartData4" :options="overviewChartOptions4" :height="60" :width="160" />
          </div>
        </div>
      </div>
    </div>
    ...
    <div class="col-span-12 lg:col-span-6">
      <div class="card h-full">
        ...
        <Chart type="line" :data="ordersChart" :options="ordersOptions" :height="375" :width="300" />
      </div>
    </div>
    ...
    <div class="col-span-12 md:col-span-12 lg:col-span-6">
      <div class="card h-full">
        <DataTable :value="products" :paginator="true" :rows="8" :style="{ minWidth: '40rem' }">
          ...
          <Column field="category" header="Category" :sortable="true" header-style="min-width:8rem;">
            <template #body="slotProps">
    ...
    <div class="col-span-12 lg:col-span-6">
      <div class="card h-full">
        <div class="flex items-center justify-between mb-4">
          ...
          <div>
            <Button icon="pi pi-ellipsis-h" class="mb-1 mr-2" rounded text plain @click="toggleMenu" />
            <Menu ref="menu8" :popup="true" :model="items3" />
          </div>
        </div>
        <div>
          <ul ref="chatcontainer" class="chat-container m-0 px-4 pt-4 pb-0 border-0 list-none h-[30rem] overflow-y-auto outline-0">
            <li
          ...
          <InputGroup class="mt-4">
            ...
            <InputGroupAddon class="p-0 overflow-hidden rounded-3xl rounded-l-none">
              ...
              <Popover ref="op" class="emoji" style="width: 45em">
                <Button v-for="emoji in chatEmojis" :key="emoji" type="button" :label="emoji" class="emoji-button p-2" text plain @click="onEmojiOverlayPanel(emoji)" />
              </Popover>
            </InputGroupAddon>
          </InputGroup>
        </div>
    ...
    <div class="col-span-12 lg:col-span-3">
      <div class="card h-full">
        ...
        <ul class="m-0 p-0 border-0 outline-0 list-none">
          <li class="py-4 px-0">
            <div class="rounded h-16 bg-surface-200 dark:bg-surface-600 transition-transform duration-200 flex items-center p-4 mb-2 cursor-pointer hover:bg-surface-100 dark:hover:bg-surface-700">
              <img width="32px" height="32px" class="rounded-full mr-4" src="/demo/images/product/blue-band.jpg" alt="product" />
              <span>Blue Band</span>
              <span class="ml-auto"
            ...
            <div class="rounded h-16 bg-surface-200 dark:bg-surface-600 transition-transform duration-200 flex items-center p-4 mb-2 cursor-pointer hover:bg-surface-100 dark:hover:bg-surface-700">
              <img width="32px" height="32px" class="rounded-full mr-4" src="/demo/images/product/bracelet.jpg" alt="product" />
              <span>Bracelet</span>
              <span class="ml-auto"
                ><a href="#"><i class="pi pi-chevron-right text-muted-color" /></a
              ></span>
            ...
            <div class="rounded h-16 bg-surface-200 dark:bg-surface-600 transition-transform duration-200 flex items-center p-4 mb-2 cursor-pointer hover:bg-surface-100 dark:hover:bg-surface-700">
              <img width="32px" height="32px" class="rounded-full mr-4" src="/demo/images/product/black-watch.jpg" alt="product" />
            ...
            <div class="rounded h-16 bg-surface-200 dark:bg-surface-600 transition-transform duration-200 flex items-center p-4 mb-2 cursor-pointer hover:bg-surface-100 dark:hover:bg-surface-700">
              <img width="32px" height="32px" class="rounded-full mr-4" src="/demo/images/product/bamboo-watch.jpg" alt="product" />
            ...
            <div class="rounded h-16 bg-surface-200 dark:bg-surface-600 transition-transform duration-200 flex items-center p-4 mb-2 cursor-pointer hover:bg-surface-100 dark:hover:bg-surface-700">
              <img width="32px" height="32px" class="rounded-full mr-4" src="/demo/images/product/blue-t-shirt.jpg" alt="product" />
            ...
            <div class="rounded h-16 bg-surface-200 dark:bg-surface-600 transition-transform duration-200 flex items-center p-4 mb-2 cursor-pointer hover:bg-surface-100 dark:hover:bg-surface-700">
              <img width="32px" height="32px" class="rounded-full mr-4" src="/demo/images/product/game-controller.jpg" alt="product" />
            ...
            <div class="rounded h-16 bg-surface-200 dark:bg-surface-600 transition-transform duration-200 flex items-center p-4 mb-2 cursor-pointer hover:bg-surface-100 dark:hover:bg-surface-700">
              <img width="32px" height="32px" class="rounded-full mr-4" src="/demo/images/product/gold-phone-case.jpg" alt="product" />
