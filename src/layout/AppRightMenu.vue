  ...
  <Drawer v-model:visible="layoutState.rightMenuActive" position="right" pt:header="!hidden" pt:content="!p-3">
    <div class="p-4">
      ...
      <div class="flex flex-col mb-8">
        ...
        <div class="flex pt-2">
          <i class="pi pi-images self-start p-2 border border-transparent rounded-full mr-2" style="background-color: rgba(0, 0, 0, 0.12)" />
      ...
      <div class="flex flex-col">
        ...
        <ul class="m-0 list-none p-0">
          <li class="py-4 px-2 rounded-md hover:bg-emphasis cursor-pointer"><i class="pi pi-eye mr-4" />A/B Test</li>
          <li class="py-4 px-2 rounded-md hover:bg-emphasis cursor-pointer"><i class="pi pi-video mr-4" />Video Shoot</li>
          <li class="py-4 px-2 rounded-md hover:bg-emphasis cursor-pointer"><i class="pi pi-sitemap mr-4" />Board Meeting</li>
          <li class="py-4 px-2 rounded-md hover:bg-emphasis cursor-pointer"><i class="pi pi-compass mr-4" />Q4 Planning</li>
          <li class="py-4 px-2 rounded-md hover:bg-emphasis cursor-pointer"><i class="pi pi-palette mr-4" />Design Training</li>
        </ul>
      </div>
    </div>
  </Drawer>
