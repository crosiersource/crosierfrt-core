    ...
    <div class="grid grid-cols-12 gap-4 -mt-4 -ml-4 -mr-4">
      ...
      >
        <div class="mb-4 relative">
          ...
          >
            <i class="pi pi-shopping-cart mr-4 text-base" />
        ...
        <div class="flex flex-col items-center">
          ...
          <div class="flex items-center mb-4">
            <div
              ...
              :style="{
                'box-shadow':
                  product.color === 'Bluegray' ? '0 0 0 0.2rem var(--p-bluegray-500)' : null,
              }"
            ...
            <div
              ...
              :style="{
                'box-shadow':
                  product.color === 'Indigo' ? '0 0 0 0.2rem var(--p-indigo-500)' : null,
              }"
            ...
            <div
              ...
              :style="{
                'box-shadow':
                  product.color === 'Purple' ? '0 0 0 0.2rem var(--p-purple-500)' : null,
              }"
