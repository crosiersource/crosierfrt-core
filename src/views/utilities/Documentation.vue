<template>
  <div class="card">
    ...
    <p class="text-lg mb-4">
      ...
      >create-vue</a>, the recommended way to start a Vite-powered Vue projects.
    </p>
    <p class="text-lg mb-4">
...
npm run dev</code></pre>
    ...
    <ul class="leading-normal list-disc pl-8 text-lg mb-4">
      ...
      <li>
        <span class="text-primary font-medium">public/demo</span>: Publicly accessible assets used
        in demos
      </li>
      <li>
        <span class="text-primary font-medium">public/layout</span>: Publicly accessible assets used
        in layout
      </li>
      <li><span class="text-primary font-medium">src/assets/demo</span>: Styles used in demos</li>
      <li>
        <span class="text-primary font-medium">src/assets/layout</span>: Styles of the main layout
      </li>
    </ul>
...
&#125;,</code></pre>
    ...
    <p>
      ...
      <span class="text-primary font-medium">src/assets/layout/topbar/themes</span> folder with the
      content below using your own values. The style class name must begin with
...
&#125;
    ...
    <p>
      ...
      the <b>Default Configuration</b> section for details.
    </p>
...
&#125;);</code></pre>
    ...
    <p>
      ...
      a file like <span class="text-primary font-medium">_menu_mymenu</span> under
      <span class="text-primary font-medium">src/assets/layout/sidebar/themes</span> folder with the
      content below using your own values. The style class name must begin with
...
&#125;
    ...
    <p>
      Next step is including your file in
      <span class="text-primary font-medium">src/assets/layout/sidebar/_sidebar.scss</span> file.
    </p>
...
&#125;);</code></pre>
    ...
    <p class="text-lg mb-4">
      ...
      use the files under
      <span class="bg-highlight px-2 py-1 rounded-border not-italic text-base">src/assets/layout/_variables.scss</span>
