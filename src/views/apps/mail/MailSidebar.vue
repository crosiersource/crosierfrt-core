    ...
    <div class="overflow-auto">
      <ul class="flex flex-row md:flex-col gap-1 md:gap-2 list-none m-0 p-0 overflow-auto">
        <li
          ...
          @click="navigate(item)"
        >
          <i class="md:mr-4 text-surface-600 dark:text-surface-200 duration-150 text-lg" :class="[item.icon, { 'text-primary-50': router.currentRoute.value.path === item.routerLink }]" />
