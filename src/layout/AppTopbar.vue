  ...
  <div class="layout-topbar">
    <div class="layout-topbar-start">
      <RouterLink class="layout-topbar-logo" to="/">
        <Image src="https://www.crosier.com.br/imgs/CROSIER_branco_transp.png" alt="Image" width="180" class="layout-topbar-logo-full" />
        <Image src="https://www.crosier.com.br/imgs/CROSIER_branco_transp.png" alt="Image" width="70" class="layout-topbar-logo-slim" />
      </RouterLink>
      ...
      <div class="layout-topbar-actions-end">
        <ul class="layout-topbar-items">
          <li class="layout-topbar-search">
            <a v-styleclass="{ selector: '@next', enterFromClass: '!hidden', enterActiveClass: 'animate-scalein', leaveToClass: '!hidden', leaveActiveClass: 'animate-fadeout', hideOnOutsideClick: true }" @click="focusSearchInput()">
              <i class="pi pi-search" />
            </a>

            <div class="layout-search-panel !hidden">
              <i class="pi pi-search" />
              <InputText ref="searchInput" placeholder="Search" variant="filled" />
              <Button v-styleclass="{ selector: '.layout-search-panel', leaveToClass: '!hidden', leaveActiveClass: 'animate-fadeout' }" type="button" icon="pi pi-times" rounded text plain />
            </div>
          </li>
          <li>
            ...
            <div class="hidden">
              <div class="flex flex-wrap">
                <div class="w-4/12 flex flex-col items-center p-4">
                  <Button class="mb-2" rounded icon="pi pi-image" />
                  <span>Products</span>
                </div>
                <div class="w-4/12 flex flex-col items-center p-4">
                  <Button class="mb-2" severity="success" rounded icon="pi pi-file-pdf" />
                  <span>Reports</span>
                </div>
                <div class="w-4/12 flex flex-col items-center p-4">
                  <Button class="mb-2" severity="secondary" rounded icon="pi pi-dollar" />
                  <span>Balance</span>
                </div>
                <div class="w-4/12 flex flex-col items-center p-4">
                  <Button class="mb-2" severity="warn" rounded icon="pi pi-cog" />
                  <span>Settings</span>
                </div>
                <div class="w-4/12 flex flex-col items-center p-4">
                  <Button class="mb-2" severity="help" rounded icon="pi pi-key" />
                  <span>Credentials</span>
                </div>
                <div class="w-4/12 flex flex-col items-center p-4">
                  <Button class="mb-2" severity="info" rounded icon="pi pi-sitemap" />
                  <span>Sitemap</span>
                </div>
              </div>
            </div>
          ...
          <li>
            <a class="" @click="openRightSidebar">
