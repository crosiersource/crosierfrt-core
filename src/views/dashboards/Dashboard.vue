                    ...
                    <li class="py-4 px-0 border-b border-surface">
                        <div class="activity-item flex flex-col">
                            ...
                            <div class="bg-surface-50 dark:bg-surface-800" style="height: 6px">
                                <div class="bg-yellow-500 w-6/12 h-full rounded-lg"></div>
                            </div>
                        </div>
                    </li>
                    <li class="py-4 px-0 border-b border-surface">
                        <div class="activity-item flex flex-col">
                            ...
                            <div class="bg-surface-50 dark:bg-surface-800" style="height: 6px">
                                <div class="bg-pink-500 w-6/12 h-full rounded-lg"></div>
                            </div>
                        </div>
                    </li>
                    <li class="py-4 px-0 border-b border-surface">
                        <div class="activity-item flex flex-col">
                            ...
                            <div class="bg-surface-50 dark:bg-surface-800" style="height: 6px">
                                <div class="bg-cyan-600 w-6/12 h-full rounded-lg"></div>
                            </div>
                        </div>
                    </li>
                    <li class="py-4 px-0 border-b border-surface">
