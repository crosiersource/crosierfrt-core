...
const { layoutState, layoutConfig, setPrimary, setSurface, setPreset, setMenuMode, setMenuTheme, setTopbarTheme, setProfilePosition, onConfigSidebarToggle, toggleDarkMode, isDarkTheme } = useLayout();
    ...
    <div class="flex flex-col gap-4">
      ...
      <div>
        <div class="flex flex-col gap-2">
          ...
          <SelectButton v-model="darkTheme" :options="themeOptions" option-label="name" option-value="value" :allow-empty="false" @change="toggleDarkMode" />
        </div>
      </div>
      ...
      <template v-if="!simple">
            ...
            <div class="flex flex-wrap flex-col gap-3">
              <div class="flex">
                <div class="flex items-center gap-2 w-1/2">
                  <RadioButton v-model="menuMode" name="menuMode" value="static" input-id="mode1" @update:model-value="setMenuMode" />
                  <label for="mode1">Static</label>
                </div>

                <div class="flex items-center gap-2 w-1/2">
                  <RadioButton v-model="menuMode" name="menuMode" value="overlay" input-id="mode2" @update:model-value="setMenuMode" />
                  <label for="mode2">Overlay</label>
                </div>
              </div>
              <div class="flex">
                <div class="flex items-center gap-2 w-1/2">
                  <RadioButton v-model="menuMode" name="menuMode" value="slim" input-id="mode3" @update:model-value="setMenuMode" />
                  <label for="mode2">Slim</label>
                </div>
                <div class="flex items-center gap-2 w-1/2">
                  <RadioButton v-model="menuMode" name="menuMode" value="slim-plus" input-id="mode4" @update:model-value="setMenuMode" />
                  <label for="mode3">Slim+</label>
                </div>
              </div>
              <div class="flex">
                <div class="flex items-center gap-2 w-1/2">
                  <RadioButton v-model="menuMode" name="menuMode" value="reveal" input-id="mode5" @update:model-value="setMenuMode" />
                  <label for="mode4">Reveal</label>
                </div>
                <div class="flex items-center gap-2 w-1/2">
                  <RadioButton v-model="menuMode" name="menuMode" value="drawer" input-id="mode6" @update:model-value="setMenuMode" />
                  <label for="mode5">Drawer</label>
                </div>
              </div>
              <div class="flex">
                <div class="flex items-center gap-2 w-1/2">
                  <RadioButton v-model="menuMode" name="menuMode" value="horizontal" input-id="mode7" @update:model-value="setMenuMode" />
        ...
        <div>
          <div class="flex flex-col gap-2">
            ...
            <div class="flex flex-wrap flex-col gap-4">
              <div class="flex">
                <div class="flex items-center gap-2 w-1/2">
                  <RadioButton v-model="menuProfilePosition" name="menuProfilePosition" value="start" input-id="profile1" @update:model-value="setProfilePosition" />
                  <label for="profile1">Start</label>
                </div>

                <div class="flex items-center gap-2 w-1/2">
                  <RadioButton v-model="menuProfilePosition" name="menuProfilePosition" value="end" input-id="profile2" @update:model-value="setProfilePosition" />
        ...
        <div>
          ...
          <div v-if="!layoutConfig.darkTheme" class="pt-2 flex gap-2 flex-wrap">
            ...
            >
              <i v-if="theme.name === layoutConfig.menuTheme" :class="['pi pi-check', theme.name === layoutConfig.menuTheme && layoutConfig.menuTheme !== 'light' ? 'text-white' : 'text-dark']" />
            </button>
          </div>
          <template v-else>
        ...
        <div>
          ...
          <div class="pt-2 flex gap-2 flex-wrap">
            ...
            >
              <i v-if="theme.name === layoutConfig.topbarTheme" :class="['pi pi-check', theme.name === layoutConfig.topbarTheme && layoutConfig.topbarTheme !== 'white' ? 'text-white' : 'text-dark']" />
            </button>
          </div>
        </div>
      </template>
