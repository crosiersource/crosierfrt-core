    ...
    <div class="grid grid-cols-12 gap-4 grid-nogutter">
      ...
      <div class="col-span-12 lg:col-span-6 h-full px-6 py-6 md:px-12">
        <ul class="flex list-none flex-wrap p-0 mb-12">
          <li class="flex items-center text-primary mr-2">Cart <i class="pi pi-chevron-right text-surface-500 dark:text-surface-300 text-xs ml-2" /></li>
          <li class="flex items-center text-surface-500 dark:text-surface-300 mr-2">Information<i class="pi pi-chevron-right text-surface-500 dark:text-surface-300 text-xs ml-2" /></li>
          <li class="flex items-center text-surface-500 dark:text-surface-300 mr-2">Shipping<i class="pi pi-chevron-right text-surface-500 dark:text-surface-300 text-xs ml-2" /></li>
        ...
        <div class="grid grid-cols-12 gap-4">
          ...
          <div class="col-span-12 mb-6">
            ...
            <Select v-model="selectedCountry" :options="countries" placeholder="Country / Region" option-label="name" show-clear class="w-full" />
          </div>
          ...
          <div class="col-span-12 flex flex-col lg:flex-row justify-center items-center lg:justify-end my-12">
            <Button class="mt-4 lg:mt-0 w-full lg:w-auto order-2 lg:order-1 lg:mr-6" severity="secondary" outlined label="Return to Cart" icon="pi pi-fw pi-arrow-left" />
            <Button class="w-full lg:w-auto order-1 lg:order-2" label="Continue to Shipping" icon="pi pi-fw pi-check" />
          </div>
        </div>
      </div>
