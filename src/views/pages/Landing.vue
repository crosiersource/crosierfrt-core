...
function handleMouseEnter(event) {
  event.target.style.background =
    'linear-gradient(110.43deg, rgba(134,140,208,.5) 0.04%, rgba(255,87,89,.5) 100.11%)';
}
            ...
            <div class="flex flex-col items-center">
              ...
              >
                <div class="flex flex-col items-end justify-center">
                  ...
                  <div>
                    <h1
                      class="m-0 text-6xl font-bold text-right"
                      style="
                        background: linear-gradient(110.43deg, #868cd0 0.04%, #ff5759 100.11%);
                        background-clip: text;
                        -webkit-background-clip: text;
              ...
              <div class="py-12 px-6 mt-12 w-full flex justify-center">
                <div
                  class="p-8 flex flex-col gap-4 items-start justify-between lg:flex-row lg:items-center rounded-2xl w-full"
                  style="
                    background: linear-gradient(110.43deg, #868cd0 0.04%, #ff5759 100.11%);
                    max-width: 1200px;
                  "
                  ...
                  <div class="col-span-12 lg:col-span-3">
                    <div class="w-full text-white flex flex-col gap-4">
                      ...
                      <div class="flex gap-8">
                        <a href="#"><i class="pi pi-github text-white !text-2xl" /></a>
                        <a href="#"><i class="pi pi-twitter text-white !text-2xl" /></a>
