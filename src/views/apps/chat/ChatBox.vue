...
<template>
  <div class="flex flex-col h-full">
    ...
    <div class="p-4 md:p-6 lg:p-12 flex flex-col sm:flex-row items-center mt-auto border-t border-surface-200 dark:border-surface-700 gap-4">
      <InputText id="message" v-model="textContent" type="text" placeholder="Type a message" class="flex-1 w-full sm:w-auto rounded" @keydown.enter="sendMessage()" />
  ...
  <Popover ref="op" class="w-full sm:w-[30rem]">
    <Button v-for="emoji in emojis" :key="emoji" type="button" :label="emoji" class="p-2 text-2xl" text @click="addEmoji(emoji)" />
  </Popover>
</template>
