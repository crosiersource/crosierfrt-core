  ...
  <div class="grid grid-cols-12 gap-8">
      ...
      <div class="card h-full">
        ...
        <div class="flex flex-col justify-center">
          ...
          <div class="flex flex-row items-center my-6 px-4">
            <i class="pi pi-thumbs-down rounded-full p-4 bg-orange-400 text-white" />
            <div class="flex flex-col ml-4">
    ...
    <div class="col-span-12 md:col-span-4">
      <div class="card">
        <div class="flex justify-between items-center p-4">
          <div>
            <i class="pi pi-twitter text-blue-500 !text-6xl" />
          </div>
    ...
    <div class="col-span-12 md:col-span-4">
      <div class="card">
        <div class="flex justify-between items-center p-4">
          <div>
            <i class="pi pi-facebook text-indigo-500 !text-6xl" />
          </div>
          <div class="text-right flex flex-col">
            <span class="text-4xl">44.995</span>
    ...
    <div class="col-span-12 md:col-span-4">
      <div class="card">
        <div class="flex justify-between items-center p-4">
          <div>
            <i class="pi pi-github text-color !text-6xl" />
          </div>
          <div class="text-right flex flex-col">
      ...
      <div class="card h-full">
        ...
        <div class="flex justify-between items-center my-2 p-2 border-b border-surface">
          <div class="flex flex-col">
            <i class="pi pi-cloud text-cyan-700 text-2xl mb-2" />
        ...
        <div class="flex justify-between items-center my-2 p-2 border-b border-surface">
          <div class="flex flex-col">
            <i class="pi pi-tag text-cyan-700 text-2xl mb-2" />
        ...
        <div class="flex justify-between items-center my-2 p-2 border-b border-surface">
          <div class="flex flex-col">
            <i class="pi pi-desktop text-cyan-700 text-2xl mb-2" />
        ...
        <div class="flex justify-between items-center my-2 p-2">
          <div class="flex flex-col">
            <i class="pi pi-compass text-cyan-700 text-2xl mb-2" />
