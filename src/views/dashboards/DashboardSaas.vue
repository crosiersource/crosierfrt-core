        ...
        <div class="col-span-12 md:col-span-4">
            <div class="h-full bg-primary text-primary-contrast flex justify-between items-center pl-8 py-4 rounded-md overflow-hidden">
                <div class="flex flex-col justify-center">
                    ...
                    <div>
                        <Button icon="pi pi-database" label="See All Plans" class="!bg-white mt-4" outlined></Button>
                    </div>
                </div>
                <div><img class="-mr-4" :draggable="false" src="/demo/images/dashboard/saas-card.png" alt="" /></div>
            </div>
        </div>
                    ...
                    <div class="grid grid-cols-12 gap-8">
                        <template v-for="(project, i) in projectList" :key="project.id">
                            <div v-show="i < 2" class="col-span-12 md:col-span-4" :class="{ 'hidden md:block': i < 1 }">
                                <div @click="selectedProjectID = project.id" :class="['flex flex-col border border-surface justify-between p-4 gap-4 cursor-pointer border-round-md', { 'bg-primary border-0': selectedProjectID === project.id }]">
                                    <div class="flex justify-between items-center">
                                    ...
                                    <div class="flex gap-2 items-center">
                                        ...
                                        <div class="bg-surface-200 dark:bg-surface-600 w-full rounded-lg" :class="{ 'bg-primary-700': selectedProjectID === project.id }">
                                            <div style="height: 6px" class="bg-surface-0 dark:bg-surface-900 w-5/12 rounded-l-lg" :class="{ 'bg-primary-700': selectedProjectID !== project.id }"></div>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="col-span-12 md:col-span-4">
                            <div class="border border-surface p-4 rounded-md flex flex-col gap-4">
                                ...
                                <div class="flex flex-col gap-1">
                                    ...
                                    >
                                        <div class="flex items-center gap-4">
                                            <div :style="{ width: '7px', height: '7px' }" class="rounded-full" :class="team.badgeClass"></div>
                                ...
                                >
                                    ...
                                    <div class="col-span-2">
                                        <div class="flex justify-end">
                                            <Button class="text-surface-900 dark:text-surface-0" rounded text icon="pi pi-ellipsis-h"></Button>
                                        </div>
                                    </div>
                                </div>
                            </div>
